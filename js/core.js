  ...
  const I18N = {
    uz: {
      ...
      login: {
        ...
        subtitle: "Ismingizni kiriting va darhol ishlashni boshlang.",
        inputLabel: "Ism",
        placeholder: "masalan: Mirzobek",
        submit: "Kirish",
      ...
      danger: {
        title: "Danger Zone",
        text: "Faqat joriy user ma'lumotlari tozalanadi.",
        clear: "Barcha ma'lumotlarni tozalash",
        confirm: "Joriy user ma'lumotlarini tozalaysizmi?",
      },
      insight: {
    ...
    en: {
      ...
      login: {
        ...
        subtitle: "Enter your name and start using the app instantly.",
        inputLabel: "Name",
        placeholder: "for example: Mirzobek",
        submit: "Log in",
      ...
      danger: {
        title: "Danger Zone",
        text: "Only current user data will be removed.",
        clear: "Clear all current user data",
        confirm: "Clear all current user data?",
      },
      insight: {
    ...
    ru: {
      ...
      login: {
        ...
        subtitle: "Введите имя и сразу начните пользоваться сайтом.",
        inputLabel: "Имя",
        placeholder: "например: Mirzobek",
        submit: "Войти",
      ...
      danger: {
        title: "Опасная Зона",
        text: "Будут очищены только данные текущего пользователя.",
        clear: "Очистить все данные текущего пользователя",
        confirm: "Очистить все данные текущего пользователя?",
      },
      insight: {
